...
```
🛡️ Universal security gateway for AI agents — MCP-native. Sits between any Claude / OpenAI / Cursor / VS Code agent and the real tools, blocking destructive actions, redacting 28 PII types, detecting injection across 12 languages, tracking taint, requiring approval. < 1 ms per decision. MIT. github.com/YOUR_GH_HANDLE/jak-shield
```
